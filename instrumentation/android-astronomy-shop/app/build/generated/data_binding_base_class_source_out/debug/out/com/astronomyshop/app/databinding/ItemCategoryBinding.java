...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull CardView rootView, @NonNull ImageView imageCategory,
      @NonNull TextView textCategoryDescription, @NonNull TextView textCategoryName,
      @NonNull TextView textProductCount) {
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCategoryBinding((CardView) rootView, imageCategory, textCategoryDescription,
          textCategoryName, textProductCount);
    }
