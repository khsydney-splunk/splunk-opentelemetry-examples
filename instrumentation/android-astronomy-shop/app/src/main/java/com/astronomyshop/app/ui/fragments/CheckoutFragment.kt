...
//        }
    ...
    private fun processOrder() {
        ...
        // IMPORTANT: don't record card number / cvv / name / email / address
        val amount = viewModel.getCartTotal() // or your computed total if you have it
        val currency = "USD"
        val method = "card"
...
//                recordPaymentSuccess(orderId, amount, currency, method)
                ...
                viewModel.createOrder(
                    ...
                    paymentMethod = getCardLastFour() // last4 masked is OK
                )
